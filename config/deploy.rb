set :application, "webhipasia"
set :repository,  "git@github.com:itbakery/webhip.git"
set :user, "admin"
set :scm, :git
set  :run_method, :run
...
role :web, "www.webhipasia.com"      
role :app, "www.webhipasia.com"          
role :db,  "www.webhipasia.com", :primary => true
